...
export class Backend implements backendInterface {
    ...
    async commentOnPost(arg0: PostId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createAnnouncement(arg0: string): Promise<Announcement> {
        if (this.processError) {
            try {
    ...
    async createStory(arg0: string, arg1: ExternalBlob | null): Promise<Story> {
        if (this.processError) {
            try {
    ...
    async getConversations(): Promise<Array<[Principal, Message]>> {
        if (this.processError) {
            try {
    ...
    async getRoleBadge(arg0: Principal): Promise<UserRole> {
        if (this.processError) {
            try {
                const result = await this.actor.getRoleBadge(arg0);
    ...
    async signup(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        bio: value.bio,
        firstRegistered: value.firstRegistered,
        name: value.name,
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "admin" in value ? UserRole.admin : "owner" in value ? UserRole.owner : "user" in value ? UserRole.user : "banned" in value ? UserRole.banned : value;
}
...
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Story>): Promise<Array<Story>> {
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_UserProfile>): Promise<Array<UserProfile>> {
